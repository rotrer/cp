// source --> http://cp.local.com/wp-content/themes/cp/bootstrap-3.3.6-dist/js/bootstrap.min.js 
/*!
...
// source --> http://cp.local.com/wp-content/themes/cp/js/sliderpro-min.js 
/*!
*  - v1.1.0
...
;(function( window, $ ) {
	...
	var Thumbnails = {
		...
		thumbnailsPositionProperty: 'top',
	...
	Thumbnail.prototype = {
		...
		resizeImage: function() {
			...
			this.$thumbnail.css({ 'marginLeft': ( this.$thumbnailContainer.width() - this.$thumbnail.width() ) * 0.5, 'marginTop': ( this.$thumbnailContainer.height( ) - this.$thumbnail.height() ) * 0.1 });
		},
...
// source --> http://cp.local.com/wp-content/themes/cp/js/jquery.flex-images.min.js 
/*
...
(function($){
    $.fn.flexImages = function(options){
        var o = $.extend({ container: '.item', object: 'img', rowHeight: 250, maxRows: 0, truncate: false }, options);
        return this.each(function(){
...
// source --> http://cp.local.com/wp-content/themes/cp/js/jquery.lazyload.js 
/*!
...
// source --> http://cp.local.com/wp-content/themes/cp/js/scripts.js 
$(document).ready(function(){
