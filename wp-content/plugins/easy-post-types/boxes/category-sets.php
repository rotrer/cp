...
<table class="widefat tag fixed fields-list" cellspacing="0">
  <thead>
    <tr>
      ...
      <th class="manage-column column-ppages" id="category-sets-postpages" scope="col"><?php _e('Post & Pages', 'cct'); ?></th>
      <th class="manage-column column-rsearch" id="category-sets-refinesearch" scope="col"><?php _e('Refine on Search', 'cct'); ?></th>
  ...
  <tfoot>
    <tr>
      ...
      <th class="manage-column column-name scope="col"><?php _e('Post & Pages', 'cct'); ?></th>
      <th class="manage-column column-name scope="col"><?php _e('Refine on Search', 'cct'); ?></th>
